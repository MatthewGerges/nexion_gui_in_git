...
#define	DEVICE_USB_TOUCH_MTX_OB	"/dev/input/by-id/usb-Matrix_Orbital_Multi-Touch_Device-event-if00"
#define	DEVICE_USB_TOUCH_KUMAN	"/dev/input/by-id/usb-wch.cn_USB2IIC_CTP_CONTROL-event-if00"
#define	DEVICE_USB_TOUCH_DEV	"/dev/input/event1"
...
#  define EVDEV_CAL_FILE		"/mnt/flash/touchScreenCal"
...
/* default matrix orbitial touch screen calibration */
#    define EVDEV_MTX_OB_HOR_MIN	82
#    define EVDEV_MTX_OB_HOR_MAX	2024
#    define EVDEV_MTX_OB_VER_MIN	110
#    define EVDEV_MTX_OB_VER_MAX	1962

/* default Kuman touch screen calibration */
#    define EVDEV_KUMAN_HOR_MIN	40
#    define EVDEV_KUMAN_HOR_MAX	4048
#    define EVDEV_KUMAN_VER_MIN	40
#    define EVDEV_KUMAN_VER_MAX	4048
