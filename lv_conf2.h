...
#  define LV_MEM_SIZE    (128U * 12800U)          /*[bytes]*/
...
//#define LV_FS_STDIO_PATH "/mnt/flash/"    /*Set the working directory. If commented it will be "./" */

/*API for fopen, fread, etc*/
#define LV_USE_FS_STDIO 1
#if LV_USE_FS_STDIO
    #define LV_FS_STDIO_LETTER 'C'     /*Set an upper cased letter on which the drive will accessible (e.g. 'A')*/
    #define LV_FS_STDIO_PATH "/mnt/flash/"         /*Set the working directory. File/directory paths will be appended to it.*/
...
#if LV_USE_FS_IF
#  define LV_FS_IF_FATFS    'C'
#  define LV_FS_IF_PC       'C'
#  define LV_FS_IF_POSIX    'C'
#endif  /*LV_USE_FS_IF*/
